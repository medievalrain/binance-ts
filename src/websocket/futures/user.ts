...
export const createFuturesUserWebsocketClient = async ({
  ...
  const invertedRouting = Object.fromEntries(
    Object.entries(futuresEventRouting).map(([key, value]) => [value, key]),
  ) as {
    [K in (typeof futuresEventRouting)[keyof typeof futuresEventRouting]]: Extract<
      keyof typeof futuresEventRouting,
      {
        [P in keyof typeof futuresEventRouting]: (typeof futuresEventRouting)[P] extends K
          ? P
          : never;
      }[keyof typeof futuresEventRouting]
    >;
  ...
  const handler: ProxyHandler<{}> = {
    get(_target, method: keyof typeof futuresEventRouting) {
      return Object.freeze({
        on: (
          callback: (
            data: InferFutruresUserEvent<(typeof futuresEventRouting)[typeof method]>,
          ) => void,
          options?: CallbackOptions,
        ) => {
