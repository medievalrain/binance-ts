import { BaseRestClient } from "../base/base-rest-client";
import type {
...
export class FuturesRestClient extends BaseRestClient {
  ...
  public async oldTradesLookup(params: {
    symbol: string;
    limit?: number;
    fromId?: number;
  ...
  public async quarterlySettlementPrices(params: {
    pair: string;
  ...
  public async indexPriceConstituents(params: {
    symbol: string;
